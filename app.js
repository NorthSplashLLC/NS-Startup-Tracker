...
const ventureDefaults={
  clothing:{name:'Clothing Brand',division:'Retail',startYear:2028,firstRevenue:300000,margin:15,sameStoreGrowth:14,employees:4,employeesPerLocation:5,reinvestPct:35,maxLocationGrowthPct:60,maxLocations:85,startupEquity:30000,expansionEquity:90000,totalProjectCost:30000,locationsPerCity:1,locationsPerState:5,marketPath:'Online nationwide → Raleigh/Charlotte pop-ups → Southeast flagships → major U.S. metros',note:'Online first. Add physical retail only after profitable online demand, repeat purchase and inventory turns support it.'},
  cleaning:{name:'Commercial Cleaning',division:'Service',startYear:2029,firstRevenue:500000,margin:18,sameStoreGrowth:10,employees:12,employeesPerLocation:14,reinvestPct:45,maxLocationGrowthPct:70,maxLocations:220,startupEquity:50000,expansionEquity:75000,totalProjectCost:50000,locationsPerCity:1,locationsPerState:7,marketPath:'Triangle → NC metros → Southeast → East Coast → national B2B hubs',note:'Recurring medical, office, retail and warehouse contracts. New branches open only after existing branches are profitable.'},
  pressure:{name:'Pressure Washing',division:'Service',startYear:2030,firstRevenue:350000,margin:22,sameStoreGrowth:11,employees:6,employeesPerLocation:8,reinvestPct:45,maxLocationGrowthPct:75,maxLocations:240,startupEquity:40000,expansionEquity:60000,totalProjectCost:40000,locationsPerCity:1,locationsPerState:8,marketPath:'Triangle → NC → Southeast → Sun Belt metros → national commercial routes',note:'Cross-sell detailing, HOA and property accounts. Expand from shared service hubs where possible.'},
  landscaping:{name:'Landscaping & Property Maintenance',division:'Service',startYear:2031,firstRevenue:450000,margin:20,sameStoreGrowth:10,employees:8,employeesPerLocation:10,reinvestPct:45,maxLocationGrowthPct:70,maxLocations:260,startupEquity:50000,expansionEquity:70000,totalProjectCost:75000,locationsPerCity:1,locationsPerState:8,marketPath:'Triangle → NC metros → Southeast → East Coast/Sun Belt property-service markets',note:'Share service hubs, admin, recruiting, parking and dispatch with detailing, pressure washing and commercial cleaning.'},
  bowling:{name:'Bowling & Entertainment',division:'Entertainment',startYear:2032,firstRevenue:1800000,margin:16,sameStoreGrowth:6,employees:32,employeesPerLocation:38,reinvestPct:25,maxLocationGrowthPct:35,maxLocations:40,startupEquity:350000,expansionEquity:650000,totalProjectCost:2000000,locationsPerCity:1,locationsPerState:3,marketPath:'Raleigh acquisition → Charlotte/Greensboro → Southeast family-entertainment markets → selective national',note:'Acquire cash-flowing centers, renovate gradually, then duplicate only proven entertainment economics.'},
  commercialRE:{name:'Commercial Real Estate',division:'Real Estate',startYear:2032,firstRevenue:450000,margin:55,sameStoreGrowth:5,employees:3,employeesPerLocation:2,reinvestPct:35,maxLocationGrowthPct:40,maxLocations:150,startupEquity:450000,expansionEquity:500000,totalProjectCost:2500000,locationsPerCity:2,locationsPerState:10,marketPath:'Own operating buildings first → NC income properties → Southeast portfolio → diversified U.S. holdings',note:'Prioritize owner-occupied buildings and income assets with durable tenants and conservative leverage.'},
  constructionMgmt:{name:'Construction Management',division:'Construction',startYear:2033,firstRevenue:1200000,margin:12,sameStoreGrowth:10,employees:10,employeesPerLocation:12,reinvestPct:30,maxLocationGrowthPct:45,maxLocations:55,startupEquity:150000,expansionEquity:200000,totalProjectCost:250000,locationsPerCity:1,locationsPerState:4,marketPath:'NC projects → Southeast regional offices → markets where M Holdings develops assets',note:'Manage internal projects first, then selectively take external work to deepen expertise and buying power.'},
  apartmentDev:{name:'Apartment Development',division:'Real Estate',startYear:2034,firstRevenue:2500000,margin:18,sameStoreGrowth:8,employees:10,employeesPerLocation:8,reinvestPct:30,maxLocationGrowthPct:35,maxLocations:35,startupEquity:1500000,expansionEquity:2500000,totalProjectCost:120000000,locationsPerCity:1,locationsPerState:3,marketPath:'First NC community → Carolinas → Southeast growth metros → selective national developments',note:'Treat each location as an active development platform/project. Outside equity and construction debt fund most project cost.'},
  propertyMgmt:{name:'Property Management',division:'Real Estate',startYear:2035,firstRevenue:650000,margin:20,sameStoreGrowth:10,employees:12,employeesPerLocation:14,reinvestPct:40,maxLocationGrowthPct:60,maxLocations:140,startupEquity:100000,expansionEquity:120000,totalProjectCost:150000,locationsPerCity:1,locationsPerState:7,marketPath:'Manage M Holdings assets → third-party NC → Southeast → multi-state portfolio',note:'Build around owned properties, then add third-party units only where local density supports efficient teams.'},
  apartmentPortfolio:{name:'Apartment Ownership',division:'Real Estate',startYear:2036,firstRevenue:7500000,margin:48,sameStoreGrowth:5,employees:14,employeesPerLocation:7,reinvestPct:28,maxLocationGrowthPct:30,maxLocations:70,startupEquity:6000000,expansionEquity:4500000,totalProjectCost:120000000,locationsPerCity:1,locationsPerState:4,marketPath:'First stabilized luxury community → Carolinas → Southeast portfolio → diversified multifamily markets',note:'Locations represent stabilized communities. Expansion is intentionally slower because every asset requires substantial equity.'},
  generalContracting:{name:'General Contracting',division:'Construction',startYear:2036,firstRevenue:4500000,margin:9,sameStoreGrowth:10,employees:28,employeesPerLocation:30,reinvestPct:25,maxLocationGrowthPct:45,maxLocations:70,startupEquity:500000,expansionEquity:450000,totalProjectCost:1000000,locationsPerCity:1,locationsPerState:4,marketPath:'NC → Southeast offices aligned with development pipeline → selective external commercial work',note:'Use regional offices to serve internal development first; outside work fills capacity without distracting from core projects.'},
  hospitality:{name:'Hospitality & Resorts',division:'Hospitality',startYear:2038,firstRevenue:6000000,margin:20,sameStoreGrowth:7,employees:70,employeesPerLocation:85,reinvestPct:22,maxLocationGrowthPct:30,maxLocations:22,startupEquity:4000000,expansionEquity:6000000,totalProjectCost:25000000,locationsPerCity:1,locationsPerState:2,marketPath:'Boutique NC/Southeast property → destination resorts → coastal/tourism markets → island operating expertise',note:'Scale slowly. Every new property must prove guest satisfaction, stabilized occupancy and management depth.'},
  investment:{name:'Investment Company',division:'Capital',startYear:2039,firstRevenue:1200000,margin:35,sameStoreGrowth:15,employees:8,employeesPerLocation:10,reinvestPct:20,maxLocationGrowthPct:25,maxLocations:12,startupEquity:750000,expansionEquity:400000,totalProjectCost:1000000,locationsPerCity:1,locationsPerState:2,marketPath:'Central capital team → Southeast investor network → national institutional relationships',note:'Remain centralized longer than operating companies; add offices only when deal flow and investor relationships justify them.'},
  siteDev:{name:'Site Development',division:'Construction',startYear:2039,firstRevenue:5000000,margin:10,sameStoreGrowth:10,employees:35,employeesPerLocation:40,reinvestPct:25,maxLocationGrowthPct:40,maxLocations:55,startupEquity:1200000,expansionEquity:900000,totalProjectCost:3000000,locationsPerCity:1,locationsPerState:4,marketPath:'Internal NC projects → Southeast regional crews → external infrastructure/site contracts',note:'Heavy-equipment branches follow development density; do not scatter equipment across thin markets.'},
  island:{name:'Island Development',division:'Island',startYear:2045,firstRevenue:0,margin:0,sameStoreGrowth:0,employees:10,employeesPerLocation:120,reinvestPct:0,maxLocationGrowthPct:0,maxLocations:1,startupEquity:1500000,expansionEquity:0,totalProjectCost:150000000,locationsPerCity:1,locationsPerState:1,marketPath:'2045 feasibility → 2046 financing/logistics → 2047 acquisition + infrastructure',note:'2045 feasibility → 2046 financing/logistics → 2047 acquisition and infrastructure launch.',isIsland:true,island2047Equity:15000000}
};
...
function venturePlan(v,endYear=2047){
  const out={};
  let locations=0, prevRevenue=0, expansionReserve=0;
  for(let y=v.startYear;y<=endYear;y++){
    const age=y-v.startYear;
    if(v.isIsland){
      const expansion=y===2047?(v.island2047Equity||0):0;
      const capex=(age===0?v.startupEquity:0)+expansion;
      out[y]={revenue:0,opProfit:0,capex,netCash:-capex,employees:y<2047?v.employees:Math.max(v.employees,120),locations:1,cities:1,states:1,newLocations:age===0?1:0,marketPath:v.marketPath};
      continue;
    }
    if(age===0){
      locations=1;
      const revenue=v.firstRevenue;
      const opProfit=revenue*v.margin/100;
      const capex=v.startupEquity;
      expansionReserve=Math.max(0,opProfit)*(v.reinvestPct||0)/100;
      out[y]={revenue,opProfit,capex,netCash:opProfit-capex,employees:Math.max(v.employees,Math.round(locations*v.employeesPerLocation)),locations,cities:1,states:1,newLocations:1,marketPath:v.marketPath,expansionReserve};
      prevRevenue=revenue;
      continue;
    }
    const prev=out[y-1];
    // Expansion is funded from a controlled share of prior operating profit, then capped so branches never grow recklessly in one year.
    expansionReserve+=Math.max(0,prev.opProfit)*(v.reinvestPct||0)/100;
    const affordable=Math.floor(expansionReserve/Math.max(1,v.expansionEquity));
    const growthCap=Math.max(1,Math.ceil(prev.locations*(v.maxLocationGrowthPct||0)/100));
    const remaining=Math.max(0,(v.maxLocations||9999)-prev.locations);
    const newLocations=Math.min(affordable,growthCap,remaining);
    locations=prev.locations+newLocations;
    const sameStoreFactor=1+(v.sameStoreGrowth||0)/100;
    const establishedRevenue=prev.revenue*sameStoreFactor;
    // New branches ramp at 70% of first-year mature location revenue in their opening year.
    const newLocationRevenue=newLocations*v.firstRevenue*0.70;
    const revenue=establishedRevenue+newLocationRevenue;
    const scaleMarginBonus=Math.min(4,Math.log2(Math.max(1,locations))*0.45);
    const effectiveMargin=Math.min(v.margin+scaleMarginBonus,v.margin+4);
    const opProfit=revenue*effectiveMargin/100;
    const capex=newLocations*v.expansionEquity;
    expansionReserve=Math.max(0,expansionReserve-capex);
    // A portion of current-year profit is earmarked for the next expansion cycle; capex is still shown separately as cash invested.
    const netCash=opProfit-capex;
    const employees=Math.max(v.employees,Math.round(locations*v.employeesPerLocation*Math.pow(revenue/Math.max(1,locations*v.firstRevenue),0.35)));
    const cities=Math.max(1,Math.ceil(locations/Math.max(1,v.locationsPerCity||1)));
    const states=Math.max(1,Math.ceil(locations/Math.max(1,v.locationsPerState||5)));
    out[y]={revenue,opProfit,capex,netCash,employees,locations,cities,states,newLocations,marketPath:v.marketPath,effectiveMargin,expansionReserve};
    prevRevenue=revenue;
  }
  return out;
}
...
function renderVentureCards(){const root=document.querySelector('#ventureCards');root.innerHTML=Object.entries(ventures).map(([id,v])=>{const y2047=ventureYear(v,2047);return `<article class="venture-card"><div class="venture-head"><div><span class="kicker">${v.division.toUpperCase()}</span><h3>${v.name}</h3><p>${v.note}</p></div><div class="venture-year">${v.startYear}</div></div><div class="venture-body"><div class="venture-stats"><div class="venture-stat"><span>2047 REVENUE</span><b>${compactMoney(y2047?.revenue||0)}</b></div><div class="venture-stat"><span>2047 PROFIT</span><b class="${(y2047?.opProfit||0)>=0?'positive':'negative'}">${compactMoney(y2047?.opProfit||0)}</b></div><div class="venture-stat"><span>EMPLOYEES</span><b>${num(y2047?.employees||0)}</b></div><div class="venture-stat"><span>2047 LOCATIONS</span><b>${num(y2047?.locations||0)}</b></div><div class="venture-stat"><span>EST. STATES</span><b>${num(y2047?.states||0)}</b></div></div><div class="venture-inputs">${[['startYear','Launch year'],['firstRevenue','Year-1 revenue ($)'],['margin','Base operating margin (%)'],['sameStoreGrowth','Same-location growth (%)'],['employees','Starting employees'],['employeesPerLocation','Employees / location'],['reinvestPct','Profit reinvested into expansion (%)'],['maxLocationGrowthPct','Max branch growth / year (%)'],['maxLocations','2047 location ceiling'],['startupEquity','Launch cash equity ($)'],['expansionEquity','Expansion cash/location ($)'],['totalProjectCost','Total project/value ($)'],['locationsPerState','Locations / state estimate']].map(([k,l])=>`<div class="venture-input"><label>${l}</label><input type="number" step="0.01" data-venture="${id}" data-field="${k}" value="${v[k]}"></div>`).join('')}${v.isIsland?`<div class="venture-input"><label>2047 purchase equity ($)</label><input type="number" data-venture="${id}" data-field="island2047Equity" value="${v.island2047Equity}"></div>`:''}</div><p class="venture-note"><b>Expansion path:</b> ${v.marketPath||'Build density first, then expand regionally.'}</p><p class="venture-note">Expansion is profit-driven. Service brands share regional M Holdings hubs where they overlap, reducing duplicate rent, admin and recruiting overhead. Cash equity is the M Holdings contribution; total project value can be larger through financing/investors.</p></div></article>`;}).join('');root.onchange=e=>{const id=e.target.dataset.venture,field=e.target.dataset.field;if(!id||!field)return;ventures[id][field]=+e.target.value;localStorage.setItem('mhVentures',JSON.stringify(ventures));renderAll(true);};}

function renderDetail(detailModel){renderFounder();document.querySelector('#heroTicket').textContent=money(detail.ticket);const summaryYears=[2027,2028,2029,2030];document.querySelector('#detailYearSummary').innerHTML=summaryYears.map(y=>{const t=detailModel.totals[y],e=detailModel.endState[y];return `<div class="year-summary-card"><span>${y} REVENUE</span><strong>${compactMoney(t.revenue)}</strong><b class="year-profit ${t.opProfit>=0?'positive':'negative'}">${compactMoney(t.opProfit)} profit</b><small>${pct(t.opProfit/t.revenue*100)} margin · ${e.det} detailers · ${e.off} service markets</small></div>`;}).join('');
  const open=new Set(JSON.parse(sessionStorage.getItem('mhDetailOpen')||'[2027]'));document.querySelector('#detailYears').innerHTML=[2027,2028,2029,2030].map(y=>{const t=detailModel.totals[y],e=detailModel.endState[y],rows=detailModel.rowsByYear[y],isOpen=open.has(y);return `<div class="year-group ${isOpen?'open':''}" data-detail-year="${y}"><button class="year-toggle" type="button"><span class="year-label">${y}</span><span class="year-meta"><span>Revenue <b>${compactMoney(t.revenue)}</b></span><span>Profit <b class="${t.opProfit>=0?'positive':'negative'}">${compactMoney(t.opProfit)}</b></span><span>Cash <b>${compactMoney(t.netCash)}</b></span><span>EOY <b>${e.det} detailers · ${e.d2d} D2D · ${e.off} markets</b></span></span><span class="chevron">⌄</span></button><div class="year-months"><div class="tablewrap"><table><thead><tr><th>Month</th><th>Detailers</th><th>D2D</th><th>Vans</th><th>Managers</th><th>Service Markets</th><th>Revenue</th><th>Avg D2D %</th><th>Operating Profit</th><th>Net Cash Flow</th></tr></thead><tbody>${rows.map(r=>`<tr><td>${r.label}</td><td>${r.det}</td><td>${r.d2d}</td><td>${r.vans}</td><td>${r.mgr}</td><td>${r.off}</td><td>${money(r.rev)}</td><td>${pct(r.avgComm)}</td><td class="${r.opProfit>=0?'positive':'negative'}">${money(r.opProfit)}</td><td class="${r.netCash>=0?'positive':'negative'}">${money(r.netCash)}</td></tr>`).join('')}</tbody></table></div></div></div>`;}).join('');document.querySelectorAll('[data-detail-year] .year-toggle').forEach(btn=>btn.onclick=()=>{const g=btn.closest('.year-group');g.classList.toggle('open');sessionStorage.setItem('mhDetailOpen',JSON.stringify([...document.querySelectorAll('[data-detail-year].open')].map(x=>+x.dataset.detailYear)));});
...
function renderPortfolio(portfolio,detailModel){const active2047=portfolio[2047].companies.length,tot2047=portfolio[2047].total;document.querySelector('#heroVentures').textContent=active2047;const cumulativeRevenue=Object.values(portfolio).reduce((a,y)=>a+y.total.revenue,0),cumulativeProfit=Object.values(portfolio).reduce((a,y)=>a+y.total.opProfit,0);document.querySelector('#portfolioKpis').innerHTML=[['2047 revenue',compactMoney(tot2047.revenue),'Annual portfolio revenue'],['2047 operating profit',compactMoney(tot2047.opProfit),pct(tot2047.opProfit/tot2047.revenue*100)+' margin'],['2047 employees',num(tot2047.employees),'Across active companies'],['2027–47 revenue',compactMoney(cumulativeRevenue),'Scenario cumulative'],['2027–47 profit',compactMoney(cumulativeProfit),'Before expansion cash']].map(([a,b,c])=>`<div class="kpi"><span>${a.toUpperCase()}</span><strong>${b}</strong><small>${c}</small></div>`).join('');
  const open=new Set(JSON.parse(sessionStorage.getItem('mhPortfolioOpen')||'[2027,2030,2040,2047]'));document.querySelector('#portfolioYears').innerHTML=Object.entries(portfolio).map(([y,data])=>{const yr=+y,isOpen=open.has(yr),launches=data.companies.filter(c=>c.id!=='detailing'&&ventures[c.id]?.startYear===yr).map(c=>c.name),t=data.total;return `<div class="year-group ${isOpen?'open':''}" data-port-year="${yr}"><button class="year-toggle" type="button"><span class="year-label">${yr}</span><span class="year-meta"><span>Revenue <b>${compactMoney(t.revenue)}</b></span><span>Profit <b class="${t.opProfit>=0?'positive':'negative'}">${compactMoney(t.opProfit)}</b></span><span>Net cash <b class="${t.netCash>=0?'positive':'negative'}">${compactMoney(t.netCash)}</b></span><span>Employees <b>${num(t.employees)}</b></span>${launches.length?`<span>Launch <b>${launches.join(' · ')}</b></span>`:''}</span><span class="chevron">⌄</span></button><div class="year-months"><div class="tablewrap"><table><thead><tr><th>Company</th><th>Division</th><th>Revenue</th><th>Operating Profit</th><th>Expansion Cash</th><th>Net Cash Flow</th><th>Employees</th><th>Locations/Assets</th><th>Cities</th><th>States</th></tr></thead><tbody>${data.companies.map(c=>`<tr><td>${c.name}</td><td>${c.division}</td><td>${money(c.revenue)}</td><td class="${c.opProfit>=0?'positive':'negative'}">${money(c.opProfit)}</td><td>${money(c.capex)}</td><td class="${c.netCash>=0?'positive':'negative'}">${money(c.netCash)}</td><td>${num(c.employees)}</td><td>${num(c.locations||0)}</td><td>${num(c.cities||Math.ceil((c.locations||1)/2))}</td><td>${num(c.states||1)}</td></tr>`).join('')}</tbody></table></div></div></div>`;}).join('');document.querySelectorAll('[data-port-year] .year-toggle').forEach(btn=>btn.onclick=()=>{const g=btn.closest('.year-group');g.classList.toggle('open');sessionStorage.setItem('mhPortfolioOpen',JSON.stringify([...document.querySelectorAll('[data-port-year].open')].map(x=>+x.dataset.portYear)));});
  const divisions={Service:['North Splash Auto Luxe','Commercial Cleaning','Pressure Washing','Landscaping & Property Maintenance'],Retail:['Clothing Brand'],Entertainment:['Bowling & Entertainment'],'Real Estate':['Commercial Real Estate','Apartment Development','Property Management','Apartment Ownership'],Construction:['Construction Management','General Contracting','Site Development'],Hospitality:['Hospitality & Resorts'],Capital:['Investment Company'],Island:['Island Development'],'Shared Infrastructure':['Shared Service Operations Hubs']};document.querySelector('#divisionGrid').innerHTML=Object.entries(divisions).map(([d,names])=>`<div class="division-card"><h3>${d}</h3><p>${d==='Service'?'Cash-flow engines that share regional operating hubs, admin, recruiting and dispatch.':d==='Real Estate'?'Long-term assets, rent and development equity.':d==='Construction'?'Build and project execution capabilities.':d==='Hospitality'?'Destination operations before the island phase.':d==='Capital'?'Investor relationships and larger deal financing.':d==='Island'?'2045–47 feasibility, financing, acquisition and infrastructure.':'Brand and diversified operating income.'}</p><div class="mini-tags">${names.map(n=>`<span class="mini-tag">${n}</span>`).join('')}</div></div>`).join('');
}

function renderMarkets(portfolio){
  const y=2047,data=portfolio[y];
  const totalLocations=data.companies.reduce((a,c)=>a+(c.locations||0),0);
  const maxStates=Math.max(...data.companies.map(c=>c.states||1));
  const expansionCash=Object.values(portfolio).reduce((a,yr)=>a+yr.total.capex,0);
  document.querySelector('#marketKpis').innerHTML=[['2047 locations/assets',num(totalLocations),'Across the full portfolio'],['Largest state footprint',num(maxStates),'Estimated states for widest division'],['2047 active companies',num(data.companies.length),'Operating ventures'],['2027–47 expansion cash',compactMoney(expansionCash),'Startup + growth equity'],['Shared service hubs',num(data.companies.find(c=>c.id==='sharedHubs')?.locations||0),'Detailing + cleaning + pressure washing + landscaping']].map(([a,b,c])=>`<div class="kpi"><span>${a.toUpperCase()}</span><strong>${b}</strong><small>${c}</small></div>`).join('');
  const years=[2028,2030,2032,2035,2040,2047];
  document.querySelector('#marketCards').innerHTML=data.companies.map(c=>{
    const v=c.id==='detailing'?null:ventures[c.id];
    const path=c.marketPath||v?.marketPath||'Build density first, then expand regionally.';
    const milestones=years.map(yr=>{const co=portfolio[yr]?.companies.find(x=>x.id===c.id);return co?`<div class="market-year"><span>${yr}</span><b>${num(co.locations||0)} loc.</b><small>${num(co.cities||1)} cities · ${num(co.states||1)} states</small></div>`:''}).join('');
    return `<article class="market-card"><div class="market-card-head"><div><span class="kicker">${c.division.toUpperCase()}</span><h3>${c.name}</h3></div><b>${num(c.locations||0)} <small>2047 locations/assets</small></b></div><p>${path}</p><div class="market-years">${milestones}</div></article>`;
  }).join('');
}
...
function renderAll(refreshVentures=true){const detailModel=buildDetailModel(),portfolio=buildPortfolio(detailModel);renderDetail(detailModel);if(refreshVentures)renderVentureCards();renderPortfolio(portfolio,detailModel);renderMarkets(portfolio);renderRoadmap(portfolio);renderCapital(portfolio);}

function exportCSV(){const d=buildDetailModel(),p=buildPortfolio(d),headers=['Year','Company','Division','Revenue','Operating Profit','Expansion Cash','Net Cash Flow','Employees','Locations','Cities','States'];const lines=[headers.join(',')];Object.entries(p).forEach(([y,data])=>data.companies.forEach(c=>lines.push([y,c.name,c.division,Math.round(c.revenue),Math.round(c.opProfit),Math.round(c.capex),Math.round(c.netCash),c.employees,c.locations||0,c.cities||0,c.states||0].map(v=>`"${String(v).replaceAll('"','""')}"`).join(','))));const blob=new Blob([lines.join('\n')],{type:'text/csv'}),a=document.createElement('a');a.href=URL.createObjectURL(blob);a.download='m-holdings-2027-2047.csv';a.click();URL.revokeObjectURL(a.href);}

document.querySelector('#export').onclick=exportCSV;document.querySelector('#reset').onclick=()=>{if(confirm('Reset the entire M Holdings scenario back to the built-in defaults?')){['mhDetail','mhCapital','mhVentures','mhModelVersion'].forEach(k=>localStorage.removeItem(k));location.reload();}};
